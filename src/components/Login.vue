              ...
              <div>
                <v-form v-model="valid" ref="form">
                  ...
                  <v-layout justify-end>
                    <v-btn color='blue' class="mr-2" @click="register" :class="{ 'grey darken-1 white--text': valid, disabled: !valid }">Register</v-btn>
...
<style>
@import url("http://fonts.googleapis.com/css?family=Jolly%20Lodger");
.grey--text {
